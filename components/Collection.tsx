                    ...
                    {tiers.map((tier, index) => (
                        <CardSpotlight key={tier.key} className="group hover:shadow-2xl hover:shadow-emerald-500/[0.1] transition-all duration-300 flex flex-col h-full">
                            ...
                            <div className="flex flex-col flex-grow">
                                ...
                                <h3 className="text-2xl font-sans font-medium mb-4 text-neutral-800 group-hover:text-emerald-600 transition-colors">
                                    {tier.title}
                                </h3>
                                ...
                                <div className="mt-auto">
                                    <button className="w-full py-4 bg-[#25D366] border border-[#25D366] text-white font-bold text-xs uppercase tracking-widest hover:bg-[#128C7E] hover:border-[#128C7E] transition-all duration-300 flex items-center justify-center gap-2 rounded-lg shadow-lg group-hover:shadow-xl">
