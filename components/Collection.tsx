                        ...
                        <CardSpotlight key={tier.key} className="group hover:shadow-2xl hover:shadow-emerald-500/[0.1] transition-all duration-300 flex flex-col h-full">
                            ...
                            <div className="flex flex-col flex-grow">
                                ...
                                <div className="mt-auto">
                                    <button
                                        className="w-full py-4 text-white font-bold text-xs uppercase tracking-widest transition-all duration-300 flex items-center justify-center gap-2 rounded-lg shadow-lg group-hover:shadow-xl"
                                        style={{
